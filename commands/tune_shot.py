...
class TuneShot(Command):
    ...
    def __init__(
        ...
        table = ntcore.NetworkTableInstance.getDefault().getTable("ShotTuning")
        ...
        self._distance_sub = table.getDoubleTopic("Distance").subscribe(2.0)
        table.getDoubleTopic("Distance").publish().set(2.0)
    ...
    def record_entry(self) -> None:
        ...
        entry = (self._distance_sub.get(), self._hood_sub.get(), self._rpm_sub.get())
